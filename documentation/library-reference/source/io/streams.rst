...
Use the generic functions :gf:`lock-stream-setter`, :gf:`lock-stream` and
:gf:`unlock-stream` or the macro :macro:`with-stream-locked`, together with
other appropriate functions and macros from the :doc:`threads
<../dylan/threads>` module, to implement a locking strategy appropriate to your
application.
