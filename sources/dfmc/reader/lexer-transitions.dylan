  ...
  = compile-state-machine
       ...
       */
       ...
       state(#"double-quote", #f,
             pair('"', #"open-double-quote-2"),
             pair('\\', #"double-quote-escape"),
             pair(" !#-[]-~", #"double-quote"),
             pair($ascii-8-bit-extensions, #"double-quote")),
       state(#"open-double-quote-2", make-string-literal,
             pair('"', #"open-double-quote-3")),
       state(#"open-double-quote-3", #f,
             pair('"', #"close-double-quote"),
             pair('\\', #"open-double-quote-3-escape"),
             pair(" !#-[]-~\r\n", #"open-double-quote-3"),
             pair($ascii-8-bit-extensions, #"open-double-quote-3")),
       state(#"open-double-quote-3-escape", #f,
             pair("\\'\"abefnrt0", #"open-double-quote-3"),
             pair('<', #"open-double-quote-3-escape-less")),
       state(#"open-double-quote-3-escape-less", #f,
             pair("0-9a-fA-F", #"open-double-quote-3-hex-char-digits")),
       state(#"open-double-quote-3-hex-char-digits", #f,
             pair("0-9a-fA-F", #"open-double-quote-3-hex-char-digits"),
             pair('>', #"open-double-quote-3")),
