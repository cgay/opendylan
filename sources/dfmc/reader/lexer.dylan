...
// 'on' to new-state.  'on' can be a character or a string.  If a
// string, then it supports ranges: "-abc-gz" = match on dash, a,
// b, c through g, and z.
//
...
define method add-transition
    (transitions :: <simple-object-vector>, on :: <string>, new-state :: <symbol>)
 => ()
...
define method decode-string
 ...
 => (string :: <string>, multi-line? :: <boolean>)
  let contents = source-location.source-location-record.contents;
  let multi-line? = #f;
  local
